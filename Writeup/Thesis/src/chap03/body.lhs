...
\end{myhaskell}
  ...
  If we now test our function by calling |quickCheck reverse_preserves_length|, we 
...
\subsection{Generating Constrained Test Data}\label{genconstrainedtd}
  ...
  precondition. In some cases, such as the |insert_preserves_sorted| from section \ref
