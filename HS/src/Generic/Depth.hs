{-# LANGUAGE TypeOperators, MultiParamTypeClasses, FlexibleInstances, FlexibleContexts, DeriveGeneric, DeriveAnyClass, UndecidableInstances, DefaultSignatures, ScopedTypeVariables #-}

module Generic.Depth where 
