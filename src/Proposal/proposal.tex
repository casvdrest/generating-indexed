...
Let us reconsider the previous counter exapmle: 
...
\\
\>[B]{}\Varid{bad}\;\Varid{μ}\;\Varid{n}\;\mathrel{=}\;\Conid{Data.List.map}\;\Varid{suc}\;(\Varid{μ}\;(\Varid{1}\;\Varid{,}\;\{\mskip1.5mu \mathbin{!!}\mskip1.5mu\})){}\<[E]%
\ColumnHook
\end{hscode}\resethooks
